...
struct imgsensor_info_struct {
	 ...
	 *capture1 mode must use same framelength, linelength with Capture mode
	 *for shutter calculate
	 */
	struct imgsensor_mode_struct
	...
	kal_uint8 mipi_sensor_type;      /*0,MIPI_OPHY_NCSI2; 1,MIPI_OPHY_CSI2,
					    default is NCSI2, don't modify this
					    para*/
	...
	kal_uint8
	    i2c_addr_table[5]; /*record sensor support all write id addr, only
